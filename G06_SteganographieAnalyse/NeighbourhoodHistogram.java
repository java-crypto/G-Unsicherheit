...
public class NeighbourhoodHistogram {
	...
	public static void neighborHistogramAttack(BufferedImage image, double[] x, double[] y) {
		...
		for (Node n : ts) {
			if (ts.contains(new Node(n.red - 1, n.green - 1, n.blue - 1)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green - 1, n.blue)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green - 1, n.blue + 1)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green, n.blue - 1)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green, n.blue)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green, n.blue + 1)))
				count++;
			if (ts.contains(new Node(n.red - 1, n.green + 1, n.blue - 1)))
			...
			if (ts.contains(new Node(n.red, n.green - 1, n.blue - 1)))
				count++;
			if (ts.contains(new Node(n.red, n.green - 1, n.blue)))
				count++;
			if (ts.contains(new Node(n.red, n.green - 1, n.blue + 1)))
				count++;
			if (ts.contains(new Node(n.red, n.green, n.blue - 1)))
				count++;
			if (ts.contains(new Node(n.red, n.green, n.blue + 1)))
				count++;
			if (ts.contains(new Node(n.red, n.green + 1, n.blue - 1)))
