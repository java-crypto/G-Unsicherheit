		...
		for (int j = 0; j < height; j++) {
			for (int i = 0; i < width; i += 2) {
				if ((i + 1) < width) {
					...
					redDiff = red - red2;
					/*
					 * greenDiff = green - green2; blueDiff = blue - blue2;
					 */

					h2[redDiff + 255]++;
					/*
					 * h2[greenDiff+255]++; h2[blueDiff+255]++;
					 */

					red = new Color(image.getRGB(i, j)).getRed() & 0xFE;
					/*
					 * reen = new Color(image.getRGB(i,j)).getGreen() & 0xFE; blue = new
					 * Color(image.getRGB(i,j)).getBlue() & 0xFE;
					 */

					red2 = new Color(image.getRGB(i + 1, j)).getRed() & 0xFE;
					/*
					 * green2 = new Color(image.getRGB(i+1,j)).getGreen() & 0xFE; blue2 = new
					 * Color(image.getRGB(i+1,j)).getBlue() & 0xFE;
					 */
					...
					g2[redDiff + 255]++;
					/*
					 * g2[greenDiff+255]++; g2[blueDiff+255]++;
					 */
